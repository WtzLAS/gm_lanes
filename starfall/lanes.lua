lanes = {}
if not SF.Require("lanes.core") then
    lanes = nil
    return function() end
end
...
SF.RegisterLibrary("lanes")

SF.Permissions.registerPrivilege("lanes.create", "Create new lanes", "Allows the user to create new lanes")
SF.Permissions.registerPrivilege("lanes.linda", "Create new lindas", "Allows the user to create new lindas")

return function(instance)
    local lanesMeta = {}
    local lanes = setmetatable(instance.Libraries.lanes, lanesMeta)
    ...
    lanes.configure = function(settings_)
        ...
        local gen = function(...)
            SF.Permissions.check(SF.instance, nil, "lanes.create")
        ...
        lanes.gen = gen
        lanes.linda = function(...)
            SF.Permissions.check(SF.instance, nil, "lanes.linda")
            return core.linda(...)
        end
